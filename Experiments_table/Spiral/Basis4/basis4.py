...
bx = normalize([((i+delta)*2*math.pi/delta)*math.cos((i+delta)*2*math.pi/delta) for i in t])
by = normalize([((i+delta)*2*math.pi/delta)*math.sin((i+delta)*2*math.pi/delta) for i in t])
